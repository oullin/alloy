...
// Symbol Ordered - List of symbols to prevent partial matching (e.g. matching "$" inside "C$")
type Symbol struct {
	Id       string
	Currency string
}

// GetSymbols returns a slice of Symbol structs, ordered to prevent partial matching issues.
// For example, "C$" is listed before "$" to ensure correct identification.
func GetSymbols() []Symbol {
	return []Symbol{
		{"CFP", XPF}, // CFP Franc (XPF) - avoids ambiguity with "₣"
...
func getCurrencies() map[string]*Definition {
	return map[string]*Definition{
		...
		BOV: {Decimal: ".", Thousand: ",", Code: BOV, Fraction: 2, NumericCode: "984", Grapheme: "BOV", Template: "1 $"},
		...
		CHE: {Decimal: ".", Thousand: ",", Code: CHE, Fraction: 2, NumericCode: "947", Grapheme: "CHE", Template: "1 $"},
		CHF: {Decimal: ".", Thousand: ",", Code: CHF, Fraction: 2, NumericCode: "756", Grapheme: "CHF", Template: "1 $"},
		CHW: {Decimal: ".", Thousand: ",", Code: CHW, Fraction: 2, NumericCode: "948", Grapheme: "CHW", Template: "1 $"},
		...
		COU: {Decimal: ".", Thousand: ",", Code: COU, Fraction: 2, NumericCode: "970", Grapheme: "COU", Template: "1 $"},
		...
		MXV: {Decimal: ".", Thousand: ",", Code: MXV, Fraction: 2, NumericCode: "979", Grapheme: "MXV", Template: "1 $"},
		...
		USN: {Decimal: ".", Thousand: ",", Code: USN, Fraction: 2, NumericCode: "997", Grapheme: "US$", Template: "$1"},
		UYI: {Decimal: ".", Thousand: ",", Code: UYI, Fraction: 0, NumericCode: "940", Grapheme: "UYI", Template: "1 $"},
		UYU: {Decimal: ".", Thousand: ",", Code: UYU, Fraction: 2, NumericCode: "858", Grapheme: "$U", Template: "$1"},
		UYW: {Decimal: ".", Thousand: ",", Code: UYW, Fraction: 4, NumericCode: "927", Grapheme: "UYW", Template: "1 $"},
		...
		XBA: {Decimal: ".", Thousand: ",", Code: XBA, Fraction: 0, NumericCode: "955", Grapheme: "XBA", Template: "1 $"},
		XBB: {Decimal: ".", Thousand: ",", Code: XBB, Fraction: 0, NumericCode: "956", Grapheme: "XBB", Template: "1 $"},
		XBC: {Decimal: ".", Thousand: ",", Code: XBC, Fraction: 0, NumericCode: "957", Grapheme: "XBC", Template: "1 $"},
		XBD: {Decimal: ".", Thousand: ",", Code: XBD, Fraction: 0, NumericCode: "958", Grapheme: "XBD", Template: "1 $"},
		...
		XPD: {Decimal: ".", Thousand: ",", Code: XPD, Fraction: 0, NumericCode: "964", Grapheme: "oz t", Template: "1 $"},
		XPF: {Decimal: ".", Thousand: ",", Code: XPF, Fraction: 0, NumericCode: "953", Grapheme: "CFP", Template: "1 $"},
		XPT: {Decimal: ".", Thousand: ",", Code: XPT, Fraction: 0, NumericCode: "962", Grapheme: "oz t", Template: "1 $"},
		XSU: {Decimal: ".", Thousand: ",", Code: XSU, Fraction: 0, NumericCode: "994", Grapheme: "XSU", Template: "1 $"},
		XTS: {Decimal: ".", Thousand: ",", Code: XTS, Fraction: 0, NumericCode: "963", Grapheme: "XTS", Template: "1 $"},
		XUA: {Decimal: ".", Thousand: ",", Code: XUA, Fraction: 0, NumericCode: "965", Grapheme: "XUA", Template: "1 $"},
		XXX: {Decimal: ".", Thousand: ",", Code: XXX, Fraction: 0, NumericCode: "999", Grapheme: "XXX", Template: "1 $"},
