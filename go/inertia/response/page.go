...
import "alloy.dev/go/inertia/protocol"
...
type Page struct {
	...
	ScrollProps    map[string]protocol.Scroll `json:"scrollProps,omitempty"`
	OnceProps      map[string]protocol.Once   `json:"onceProps,omitempty"`
}
