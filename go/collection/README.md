...
[![Go Reference](https://pkg.go.dev/badge/alloy.dev/go/collection.svg)](https://pkg.go.dev/alloy.dev/go/collection)
...
[![Go Report Card](https://goreportcard.com/badge/alloy.dev/go/collection)](https://goreportcard.com/report/alloy.dev/go/collection)
...
```bash
go get alloy.dev/go/collection
```
...
import (
    "fmt"
    "alloy.dev/go/collection/collection"
)
