...
async function runAuthFlow(baseUrl) {
	...
	await waitForCurrentPath('/dashboard');
...
async function runCrmFlow(baseUrl) {
	...
	await waitForCurrentPath('/contacts');
...
async function runFeatureInteractions(baseUrl) {
	...
	browser('back');
	await waitForCurrentPath('/features/state/remember');
...
async function waitForCurrentPath(expectedPath, timeoutMs = 30_000) {
