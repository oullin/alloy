 ...
 */
export function useDemoRoute(name: string, params: Record<string, string | number> = {}): DemoRoute {
...
export const contactRoutes = {
	...
	storeNote: (contact: string | number): DemoRoute => useDemoRoute('contacts.notes.store', { contact }),
};
...
export const organizationRoutes = {
	...
	show: (organization: string | number): DemoRoute => useDemoRoute('organizations.show', { organization }),
	update: (organization: string | number): DemoRoute => useDemoRoute('organizations.update', { organization }),
};
