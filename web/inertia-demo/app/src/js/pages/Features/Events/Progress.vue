...
<template>
	<AppLayout title="Progress" :breadcrumbs="breadcrumbs">
		<div class="flex flex-1 flex-col gap-6 p-4 lg:p-6">
			<FeatureHeader title="Progress Indicator" description="Inertia shows a progress bar during page navigations. The loading bar at the top of this app demonstrates this feature." />

			<div class="grid gap-6 lg:grid-cols-2">
				<FeatureCard title="Try It" description="Navigate to see the progress bar in action.">
					<div class="space-y-4">
						<p class="text-sm">Click a link below and watch the loading bar at the top of the page. Slower endpoints make the progress bar more visible.</p>
...
createInertiaApp({
  progress: {
    ...
    showSpinner: false,
				...
				<FeatureCard title="Custom Progress Bar" description="This app uses a custom LoadingBar component.">
					<div class="space-y-3 text-sm">
						<p>
							Instead of using the built-in NProgress bar, this demo app uses a custom
							<code class="bg-muted rounded px-1.5 py-0.5 text-xs">LoadingBar</code> component that listens to router events.
						</p>
						<div class="space-y-2">
