...
const breadcrumbs = [{ title: 'Features' }, { title: 'Prefetching' }, { title: 'Stale While Revalidate' }];
				...
				<FeatureCard title="How SWR Works" description="The Stale-While-Revalidate pattern.">
					<div class="space-y-3 text-sm">
						...
						<div class="flex items-start gap-3 rounded-md border p-3">
							...
							<p>In the background, a fresh request is made. When it completes, the page updates with new data.</p>
						</div>
					</div>
				</FeatureCard>

				<FeatureCard title="SWR Cache Configuration" description="Configure cache freshness and stale windows.">
					<div class="space-y-3 text-sm">
						<p>Use the <code class="bg-muted rounded px-1.5 py-0.5 text-xs">cacheFor</code> prop with an array to set both fresh and stale durations:</p>
...
&gt;</pre>
				...
				<FeatureCard title="Try It" description="Navigate between prefetching pages to see SWR in action.">
				...
				<FeatureCard title="Benefits" description="Why use Stale-While-Revalidate?">
					<ul class="text-muted-foreground space-y-2 text-sm">
						<li class="flex items-start gap-2"><span class="text-foreground font-medium">Instant navigation</span> - Users see content immediately.</li>
						<li class="flex items-start gap-2"><span class="text-foreground font-medium">Fresh data</span> - Background revalidation keeps data current.</li>
						<li class="flex items-start gap-2"><span class="text-foreground font-medium">Reduced load</span> - Cached responses avoid redundant requests during the fresh window.</li>
					</ul>
				</FeatureCard>
			</div>
		</div>
