...
[`packages/hashing/driver.go`](https://github.com/oullin/alloy/blob/main/packages/hashing/driver.go):
...
([`packages/hashing/manager.go:15`](https://github.com/oullin/alloy/blob/main/packages/hashing/manager.go#L15)),
...
| Name       | Source                                                                                     | Notes                                       |
| ---------- | ------------------------------------------------------------------------------------------ | ------------------------------------------- |
| `bcrypt`   | [`bcrypt.go`](https://github.com/oullin/alloy/blob/main/packages/hashing/bcrypt.go)     | Sane production default; tunable cost       |
| `argon2i`  | [`argon.go`](https://github.com/oullin/alloy/blob/main/packages/hashing/argon.go)       | Memory-hard, side-channel resistant         |
| `argon2id` | [`argon2id.go`](https://github.com/oullin/alloy/blob/main/packages/hashing/argon2id.go) | Argon2 hybrid; current OWASP recommendation |
...
([`packages/contracts/hashing/hasher.go`](https://github.com/oullin/alloy/blob/main/packages/contracts/hashing))
...
```bash
go get alloy.dev/go/hashing@latest
```

When working inside this monorepo, use the repository workspace:

```bash
GOWORK=./web/storage/.cache/go.work go test -count=1 ./packages/hashing/...
```
