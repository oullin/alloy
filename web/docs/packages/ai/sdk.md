...
import (
    ...
    ai "alloy.dev/go/ai/sdk"
    contractsai "alloy.dev/go/contracts/ai"
)
...
```bash
go get alloy.dev/go/ai/sdk@latest
```

When working inside this monorepo, use the repository workspace:

```bash
GOWORK=./web/storage/.cache/go.work go test -count=1 ./packages/ai/sdk/...
```
