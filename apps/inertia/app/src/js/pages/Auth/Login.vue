...
<template>
	...
	<AuthLayout title="Alloy Inertia Demo" description="Explore the Go port of the official demo with the seeded account below.">
		...
		<form class="flex flex-col gap-6" @submit.prevent="submit">
			...
			<Label for="remember" class="flex items-center gap-3">
				<Checkbox id="remember" :checked="form.remember" @update:checked="form.remember = Boolean($event)" />
