...
This suite runs the imported Inertia demo against the Alloy Go API and drives it through Playwright. The Agent Browser runner remains available for local Helium parity checks.
...
```sh
pnpm --filter @alloy/inertia-e2e test:alloy:agent-browser
```
