...
import (
	...
	"alloy.dev/apps/inertia/api/features"
)

func (rt *runtime) registerFeatureRoutes(mux *http.ServeMux, authApp auth.App) error {
	...
	return features.RegisterRoutes(rt.routes, mux, features.Container{
		DB:          rt.db,
