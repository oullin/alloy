...
import (
    ...
    "alloy.dev/go/contracts/provider"
...
[`application.go:170`](https://github.com/oullin/alloy/blob/main/packages/container/application.go#L170).
...
([`application.go:265`](https://github.com/oullin/alloy/blob/main/packages/container/application.go#L265)):
...
([`application.go:243`](https://github.com/oullin/alloy/blob/main/packages/container/application.go#L243)).
...
- [`packages/container/application.go`](https://github.com/oullin/alloy/blob/main/packages/container/application.go)
  — the full provider lifecycle implementation.
- [`packages/contracts/provider/provider.go`](https://github.com/oullin/alloy/blob/main/packages/contracts/provider/provider.go)
