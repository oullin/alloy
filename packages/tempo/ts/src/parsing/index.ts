...
const isTempoRuntimeCarrier = (input: unknown): input is TempoRuntimeCarrier =>
  isTempoDateCarrier(input) &&
  typeof (input as { readonly getRuntime?: unknown }).getRuntime === "function";

export const runtimeFromOptions = (
...
export const escapePattern = (input: string): string =>
  input.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
