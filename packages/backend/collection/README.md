...
[![Go Reference](https://pkg.go.dev/badge/alloy.dev/backend/collection.svg)](https://pkg.go.dev/alloy.dev/backend/collection)
...
[![Go Report Card](https://goreportcard.com/badge/alloy.dev/backend/collection)](https://goreportcard.com/report/alloy.dev/backend/collection)
...
```bash
go get alloy.dev/backend/collection
```
...
import (
    "fmt"
    "alloy.dev/backend/collection/collection"
)
