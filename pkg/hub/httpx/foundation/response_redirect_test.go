...
func TestRedirectResponseSend(t *testing.T) {
	...
	resp := foundation.NewRedirectResponse(rec, raw, "/dashboard", http.StatusFound)
...
func TestRedirectResponseStatus(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	raw := httptest.NewRequest(http.MethodGet, "/", nil)
	resp := foundation.NewRedirectResponse(rec, raw, "/home", http.StatusMovedPermanently)
...
func TestRedirectResponseWithFragment(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	raw := httptest.NewRequest(http.MethodGet, "/", nil)
	resp := foundation.NewRedirectResponse(rec, raw, "/page", http.StatusFound).
...
func TestRedirectResponseWithFlashData(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	raw := httptest.NewRequest(http.MethodGet, "/", nil)
	resp := foundation.NewRedirectResponse(rec, raw, "/home", http.StatusFound).
		SetSession(session).
		With("status", "success").
...
func TestRedirectResponseWithErrors(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	raw := httptest.NewRequest(http.MethodGet, "/", nil)
	resp := foundation.NewRedirectResponse(rec, raw, "/form", http.StatusFound).
		SetSession(session).
...
func TestRedirectResponseEnforceSameOrigin(t *testing.T) {
	...
	resp := foundation.NewRedirectResponse(rec, raw, "http://example.com/path", http.StatusFound)
	...
	resp2 := foundation.NewRedirectResponse(rec, raw, "http://evil.com/path", http.StatusFound)
...
func TestRedirectResponseEnforceSameOriginRelative(t *testing.T) {
	...
	resp := foundation.NewRedirectResponse(rec, raw, "/relative/path", http.StatusFound)
...
func TestRedirectResponseAway(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	raw := httptest.NewRequest(http.MethodGet, "/", nil)
	resp := foundation.NewRedirectResponse(rec, raw, "/initial", http.StatusFound).
...
func TestRedirectResponseGetTargetURL(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	raw := httptest.NewRequest(http.MethodGet, "/", nil)
	resp := foundation.NewRedirectResponse(rec, raw, "/target", http.StatusFound)
...
func TestRedirectResponseGetStatusCode(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	raw := httptest.NewRequest(http.MethodGet, "/", nil)
	resp := foundation.NewRedirectResponse(rec, raw, "/", http.StatusFound)
...
func TestSecureRedirect(t *testing.T) {
	...
	resp := foundation.Secure(rec, raw, "/login")
	resp.Send()
