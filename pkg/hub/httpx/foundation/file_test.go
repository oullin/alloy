...
func TestFilePath(t *testing.T) {
	...
	f := foundation.NewFile("/tmp/test.txt")
...
func TestFileBasename(t *testing.T) {
	...
	f := foundation.NewFile("/tmp/dir/photo.jpg")
...
func TestFileExtension(t *testing.T) {
	...
	f := foundation.NewFile("/tmp/document.pdf")
...
func TestFileExtensionEmpty(t *testing.T) {
	...
	f := foundation.NewFile("/tmp/Makefile")
...
func TestFileHashName(t *testing.T) {
	...
	f := foundation.NewFile("/tmp/photo.jpg")
	hash := f.HashName()
