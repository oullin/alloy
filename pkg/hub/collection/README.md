...
[![Go Reference](https://pkg.go.dev/badge/hara.sh/alloy/collection.svg)](https://pkg.go.dev/hara.sh/alloy/collection)
...
[![Go Report Card](https://goreportcard.com/badge/hara.sh/alloy/collection)](https://goreportcard.com/report/hara.sh/alloy/collection)
...
```bash
go get hara.sh/alloy/collection
```
...
import (
    "fmt"
    "hara.sh/alloy/collection/collection"
)
